...
int main(int argc, char * argv[])
{
    ...
    lvl = level_new(bg);
    player2 = spawnPlayer(vector2d(400,300),gf2d_sprite_load_all("images/gokuu.png",46,65,5), 1);
    player1 = spawnPlayer(vector2d(100,300),gf2d_sprite_load_all("images/piccolo.png",85,100,6), 0);
